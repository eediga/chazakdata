                ...
                followMenuAnchor(e, t) {
                    ...
                    if (r.length) {
                        ...
                        elementorFrontend.waypoint(r, (t => {
                            "down" === t ? (i.addClass(o), e.attr("aria-current", "location")) : (i.removeClass(o), e.attr("aria-current", ""))
                        }), {
                            offset: "50%",
                            triggerOnce: !1
                        }), elementorFrontend.waypoint(r, (t => {
                            "down" === t ? (i.removeClass(o), e.attr("aria-current", "")) : (i.addClass(o), e.attr("aria-current", "location"))
                        }), {
                            offset: l,
                            triggerOnce: !1
                        })
            ...
            t.default = elementorModules.frontend.handlers.Base.extend({
                ...
                onInit() {
                    ...
                    if (e && (t = e.indexOf("<") > -1 ? e : `<i class="${e}"></i>`), this.elements.$menu.smartmenus({
                        ...
                        this.anchorLinks = new s.default, this.anchorLinks.followMenuAnchors(this.elements.$anchorLink, e)
                    }
                },
                onElementChange(e) {
