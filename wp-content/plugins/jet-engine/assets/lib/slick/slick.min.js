! function(a) {
    ...
    (a = (b = 0, function(a, d) {
        ...
        _.unload(), "number" == typeof a ? 0 === a && 0 === _.$slides.length ? $(b).appendTo(_.$slideTrack) : c ? $(b).insertBefore(_.$slides.eq(a)) : $(b).insertAfter(_.$slides.eq(a)) : !0 === c ? $(b).prependTo(_.$slideTrack) : $(b).appendTo(_.$slideTrack), _.$slides = _.$slideTrack.children(this.options.slide), _.$slideTrack.children(this.options.slide).detach(), _.$slideTrack.append(_.$slides), _.$slides.each(function(a, b) {
        ...
        var c = {},
            _ = this;
        _.animateHeight(), !0 === _.options.rtl && !1 === _.options.vertical && (a = -a), !1 === _.transformsEnabled ? !1 === _.options.vertical ? _.$slideTrack.animate({
            left: a
        }, _.options.speed, _.options.easing, b) : _.$slideTrack.animate({
            top: a
        }, _.options.speed, _.options.easing, b) : !1 === _.cssTransitions ? (!0 === _.options.rtl && (_.currentLeft = -_.currentLeft), $({
        ...
        })) : (_.applyTransition(), a = Math.ceil(a), !1 === _.options.vertical ? c[_.animType] = "translate3d(" + a + "px, 0px, 0px)" : c[_.animType] = "translate3d(0px," + a + "px, 0px)", _.$slideTrack.css(c), b && setTimeout(function() {
        ...
        var _ = this,
            a = {};
        !1 === _.options.fade ? a[_.transitionType] = _.transformType + " " + _.options.speed + "ms " + _.options.cssEase : a[_.transitionType] = "opacity " + _.options.speed + "ms " + _.options.cssEase, !1 === _.options.fade ? _.$slideTrack.css(a) : _.$slides.eq(b).css(a)
        ...
        _.paused || _.interrupted || _.focussed || (!1 === _.options.infinite && (1 === _.direction && _.currentSlide + 1 === _.slideCount - 1 ? _.direction = 0 : 0 === _.direction && (a = _.currentSlide - _.options.slidesToScroll, _.currentSlide - 1 == 0 && (_.direction = 1))), _.slideHandler(a))
        ...
        var _ = this;
        _.$slides = _.$slider.children(_.options.slide + ":not(.slick-cloned)").addClass("slick-slide"), _.slideCount = _.$slides.length, _.$slides.each(function(b, a) {
            $(a).attr("data-slick-index", b).data("originalStyling", $(a).attr("style") || "")
        ...
        if ("window" === _.respondTo ? d = g : "slider" === _.respondTo ? d = f : "min" === _.respondTo && (d = Math.min(g, f)), _.options.responsive && _.options.responsive.length && null !== _.options.responsive) {
            ...
            null !== a ? null !== _.activeBreakpoint ? (a !== _.activeBreakpoint || h) && (_.activeBreakpoint = a, "unslick" === _.breakpointSettings[a] ? _.unslick(a) : (_.options = $.extend({}, _.originalSettings, _.breakpointSettings[a]), !0 === b && (_.currentSlide = _.options.initialSlide), _.refresh(b)), e = a) : (_.activeBreakpoint = a, "unslick" === _.breakpointSettings[a] ? _.unslick(a) : (_.options = $.extend({}, _.originalSettings, _.breakpointSettings[a]), !0 === b && (_.currentSlide = _.options.initialSlide), _.refresh(b)), e = a) : null !== _.activeBreakpoint && (_.activeBreakpoint = null, _.options = _.originalSettings, !0 === b && (_.currentSlide = _.options.initialSlide), _.refresh(b), e = a), b || !1 === e || _.$slider.trigger("breakpoint", [_, e])
        }
    }, a.prototype.changeSlide = function(b, e) {
        var c, d, a = $(b.currentTarget);
        switch (a.is("a") && b.preventDefault(), a.is("li") || (a = a.closest("li")), c = this.slideCount % this.options.slidesToScroll != 0 ? 0 : (this.slideCount - this.currentSlide) % this.options.slidesToScroll, b.data.message) {
            case "previous":
        ...
        }), _.$slideTrack.children(this.options.slide).detach(), _.$slideTrack.detach(), _.$list.detach(), _.$slider.append(_.$slides)), _.cleanUpRows(), _.$slider.removeClass("slick-slider"), _.$slider.removeClass("slick-initialized"), _.$slider.removeClass("slick-dotted"), _.unslicked = !0, a || _.$slider.trigger("destroy", [_])
        ...
        var _ = this;
        !1 === _.cssTransitions ? (_.$slides.eq(a).css({
            zIndex: _.options.zIndex
        }), _.$slides.eq(a).animate({
            opacity: 1
        }, _.options.speed, _.options.easing, b)) : (_.applyTransition(a), _.$slides.eq(a).css({
            opacity: 1,
            zIndex: _.options.zIndex
        ...
        var _ = this;
        _.$slider.off("focus.slick blur.slick").on("focus.slick", "*", function(a) {
            var b = $(this);
            setTimeout(function() {
        ...
        if (!0 === this.options.infinite) {
            if (this.slideCount <= this.options.slidesToShow) ++a;
                ...
                for (; b < this.slideCount;) ++a, b = c + this.options.slidesToScroll, c += this.options.slidesToScroll <= this.options.slidesToShow ? this.options.slidesToScroll : this.options.slidesToShow
        ...
        var b, a = 0,
            c = 0,
            d = [];
        for (!1 === this.options.infinite ? b = this.slideCount : (a = -1 * this.options.slidesToScroll, c = -1 * this.options.slidesToScroll, b = 2 * this.slideCount); a < b;) d.push(a), a = c + this.options.slidesToScroll, c += this.options.slidesToScroll <= this.options.slidesToShow ? this.options.slidesToScroll : this.options.slidesToShow;
        return d
    }, a.prototype.getSlick = function() {
        return this
    }, a.prototype.getSlideCount = function() {
        var b, c, a, _ = this;
        return (a = !0 === _.options.centerMode ? Math.floor(_.$list.width() / 2) : 0, c = -1 * _.swipeLeft + a, !0 === _.options.swipeToSlide) ? (_.$slideTrack.find(".slick-slide").each(function(g, a) {
            var d, e, f;
            if (d = $(a).outerWidth(), e = a.offsetLeft, !0 !== _.options.centerMode && (e += d / 2), f = e + d, c < f) return b = a, !1
        }), Math.abs($(b).attr("data-slick-index") - _.currentSlide) || 1) : _.options.slidesToScroll
        ...
        var _ = this;
        $(_.$slider).hasClass("slick-initialized") || ($(_.$slider).addClass("slick-initialized"), _.buildRows(), _.buildOut(), _.setProps(), _.startLoad(), _.loadSlider(), _.initializeEvents(), _.updateArrows(), _.updateDots(), _.checkResponsive(!0), _.focusHandler()), a && _.$slider.trigger("init", [_]), !0 === _.options.accessibility && _.initADA(), _.options.autoplay && (_.paused = !1, _.autoPlay())
        ...
        _.$slides.add(_.$slideTrack.find(".slick-cloned")).attr({
            ...
            tabindex: "-1"
        }), null !== _.$dots && (_.$slides.not(_.$slideTrack.find(".slick-cloned")).each(function(a) {
            var b = d.indexOf(a);
            if ($(this).attr({
                    role: "tabpanel",
        ...
        }), _.$dots.attr("role", "tablist").find("li").each(function(a) {
            var b = d[a];
            $(this).attr({
                role: "presentation"
        ...
        for (var a = _.currentSlide, b = a + _.options.slidesToShow; a < b; a++) _.options.focusOnChange ? _.$slides.eq(a).attr({
            tabindex: "0"
        ...
        !0 === this.options.dots && this.slideCount > this.options.slidesToShow && ($("li", this.$dots).on("click.slick", {
            message: "index"
        }, this.changeSlide), !0 === this.options.accessibility && this.$dots.on("keydown.slick", this.keyHandler)), !0 === this.options.dots && !0 === this.options.pauseOnDotsHover && this.slideCount > this.options.slidesToShow && $("li", this.$dots).on("mouseenter.slick", $.proxy(this.interrupt, this, !0)).on("mouseleave.slick", $.proxy(this.interrupt, this, !1))
            ...
            $("img[data-lazy]", a).each(function() {
                ...
                a.onload = function() {
                    c.animate({
                        ...
                        d && (c.attr("srcset", d), e && c.attr("sizes", e)), c.attr("src", b).animate({
                            opacity: 1
                        }, 200, function() {
        ...
        if (!0 === _.options.centerMode ? !0 === _.options.infinite ? b = (a = _.currentSlide + (_.options.slidesToShow / 2 + 1)) + _.options.slidesToShow + 2 : (a = Math.max(0, _.currentSlide - (_.options.slidesToShow / 2 + 1)), b = 2 + (_.options.slidesToShow / 2 + 1) + _.currentSlide) : (b = Math.ceil((a = _.options.infinite ? _.options.slidesToShow + _.currentSlide : _.currentSlide) + _.options.slidesToShow), !0 === _.options.fade && (a > 0 && a--, b <= _.slideCount && b++)), c = _.$slider.find(".slick-slide").slice(a, b), "anticipated" === _.options.lazyLoad)
        ...
        d(c), _.slideCount <= _.options.slidesToShow ? d(_.$slider.find(".slick-slide")) : _.currentSlide >= _.slideCount - _.options.slidesToShow ? d(_.$slider.find(".slick-cloned").slice(0, _.options.slidesToShow)) : 0 === _.currentSlide && d(_.$slider.find(".slick-cloned").slice(-1 * _.options.slidesToShow))
        ...
        var _ = this;
        !_.unslicked && (_.$slider.trigger("afterChange", [_, a]), _.animating = !1, _.slideCount > _.options.slidesToShow && _.setPosition(), _.swipeLeft = null, _.options.autoplay && _.autoPlay(), !0 === _.options.accessibility && (_.initADA(), _.options.focusOnChange)) && $(_.$slides.get(_.currentSlide)).attr("tabindex", 0).focus()
        ...
        c = c || 1;
        var b, d, f, g, a, _ = this,
            e = $("img[data-lazy]", _.$slider);
        e.length ? (d = (b = e.first()).attr("data-lazy"), f = b.attr("data-srcset"), g = b.attr("data-sizes") || _.$slider.attr("data-sizes"), a = document.createElement("img"), a.onload = function() {
            f && (b.attr("srcset", f), g && b.attr("sizes", g)), b.attr("src", d).removeAttr("data-lazy data-srcset data-sizes").removeClass("slick-loading"), !0 === _.options.adaptiveHeight && _.setPosition(), _.$slider.trigger("lazyLoaded", [_, b, d]), _.progressiveLazyLoad()
        }, a.onerror = function() {
            c < 3 ? setTimeout(function() {
                _.progressiveLazyLoad(c + 1)
            }, 500) : (b.removeAttr("data-lazy").removeClass("slick-loading").addClass("slick-lazyload-error"), _.$slider.trigger("lazyLoadError", [_, b, d]), _.progressiveLazyLoad())
        }, a.src = d) : _.$slider.trigger("allImagesLoaded", [_])
    }, a.prototype.refresh = function(c) {
        var a, b, _ = this;
        b = _.slideCount - _.options.slidesToShow, !_.options.infinite && _.currentSlide > b && (_.currentSlide = b), _.slideCount <= _.options.slidesToShow && (_.currentSlide = 0), a = _.currentSlide, _.destroy(!0), $.extend(_, _.initials, {
            currentSlide: a
        }), _.init(), c || _.changeSlide({
            data: {
                message: "index",
                index: a
            }
        ...
        _.unload(), !0 === c ? _.$slideTrack.children().remove() : _.$slideTrack.children(this.options.slide).eq(a).remove(), _.$slides = _.$slideTrack.children(this.options.slide), _.$slideTrack.children(this.options.slide).detach(), _.$slideTrack.append(_.$slides), _.$slidesCache = _.$slides, _.reinit()
    }, a.prototype.setCSS = function(b) {
        var c, d, _ = this,
            a = {};
        !0 === _.options.rtl && (b = -b), c = "left" == _.positionProp ? Math.ceil(b) + "px" : "0px", d = "top" == _.positionProp ? Math.ceil(b) + "px" : "0px", a[_.positionProp] = b, !1 === _.transformsEnabled ? _.$slideTrack.css(a) : (a = {}, !1 === _.cssTransitions ? (a[_.animType] = "translate(" + c + ", " + d + ")", _.$slideTrack.css(a)) : (a[_.animType] = "translate3d(" + c + ", " + d + ", 0px)", _.$slideTrack.css(a)))
        ...
        _.$slides.each(function(c, b) {
            a = -(_.slideWidth * c * 1), !0 === _.options.rtl ? $(b).css({
                position: "relative",
                right: a,
                top: 0,
        ...
        var c, d, e, a, b, _ = this,
            f = !1;
        if ("object" === $.type(arguments[0]) ? (e = arguments[0], f = arguments[1], b = "multiple") : "string" === $.type(arguments[0]) && (e = arguments[0], a = arguments[1], f = arguments[2], "responsive" === arguments[0] && "array" === $.type(arguments[1]) ? b = "responsive" : void 0 !== arguments[1] && (b = "single")), "single" === b) _.options[e] = a;
        else if ("multiple" === b) $.each(e, function(a, b) {
            _.options[a] = b
        });
        ...
        _.positionProp = !0 === _.options.vertical ? "top" : "left", "top" === _.positionProp ? _.$slider.addClass("slick-vertical") : _.$slider.removeClass("slick-vertical"), (void 0 !== a.WebkitTransition || void 0 !== a.MozTransition || void 0 !== a.msTransition) && !0 === _.options.useCSS && (_.cssTransitions = !0), _.options.fade && ("number" == typeof _.options.zIndex ? _.options.zIndex < 3 && (_.options.zIndex = 3) : _.options.zIndex = _.defaults.zIndex), void 0 !== a.OTransform && (_.animType = "OTransform", _.transformType = "-o-transform", _.transitionType = "OTransition", void 0 === a.perspectiveProperty && void 0 === a.webkitPerspective && (_.animType = !1)), void 0 !== a.MozTransform && (_.animType = "MozTransform", _.transformType = "-moz-transform", _.transitionType = "MozTransition", void 0 === a.perspectiveProperty && void 0 === a.MozPerspective && (_.animType = !1)), void 0 !== a.webkitTransform && (_.animType = "webkitTransform", _.transformType = "-webkit-transform", _.transitionType = "webkitTransition", void 0 === a.perspectiveProperty && void 0 === a.webkitPerspective && (_.animType = !1)), void 0 !== a.msTransform && (_.animType = "msTransform", _.transformType = "-ms-transform", _.transitionType = "msTransition", void 0 === a.msTransform && (_.animType = !1)), void 0 !== a.transform && !1 !== _.animType && (_.animType = "transform", _.transformType = "transform", _.transitionType = "transition"), _.transformsEnabled = _.options.useTransform && null !== _.animType && !1 !== _.animType
        ...
        if (b = this.$slider.find(".slick-slide").removeClass("slick-active slick-center slick-current").attr("aria-hidden", "true"), this.$slides.eq(a).addClass("slick-current"), !0 === this.options.centerMode) {
            ...
            d = Math.floor(this.options.slidesToShow / 2), !0 === this.options.infinite && (a >= d && a <= this.slideCount - 1 - d ? this.$slides.slice(a - d + f, a + d + 1).addClass("slick-active").attr("aria-hidden", "false") : (c = this.options.slidesToShow + a, b.slice(c - d + 1 + f, c + d + 2).addClass("slick-active").attr("aria-hidden", "false")), 0 === a ? b.eq(this.options.slidesToShow + this.slideCount + 1).addClass("slick-center") : a === this.slideCount - 1 && b.eq(this.options.slidesToShow).addClass("slick-center")), this.$slides.eq(a).addClass("slick-center")
        } else a >= 0 && a <= this.slideCount - this.options.slidesToShow ? this.$slides.slice(a, a + this.options.slidesToShow).addClass("slick-active").attr("aria-hidden", "false") : b.length <= this.options.slidesToShow ? b.addClass("slick-active").attr("aria-hidden", "false") : (e = this.slideCount % this.options.slidesToShow, c = !0 === this.options.infinite ? this.options.slidesToShow + a : a, this.options.slidesToShow == this.options.slidesToScroll && this.slideCount - a < this.options.slidesToShow ? b.slice(c - (this.options.slidesToShow - e), c + e).addClass("slick-active").attr("aria-hidden", "false") : b.slice(c, c + this.options.slidesToShow).addClass("slick-active").attr("aria-hidden", "false"));
        ...
        if (!0 === _.options.fade && (_.options.centerMode = !1), !0 === _.options.infinite && !1 === _.options.fade && (b = null, _.slideCount > _.options.slidesToShow)) {
            for (c = !0 === _.options.centerMode ? _.options.slidesToShow + 1 : _.options.slidesToShow, a = _.slideCount; a > _.slideCount - c; a -= 1) b = a - 1, $(_.$slides[b]).clone(!0).attr("id", "").attr("data-slick-index", b - _.slideCount).prependTo(_.$slideTrack).addClass("slick-cloned");
            for (a = 0; a < c + _.slideCount; a += 1) b = a, $(_.$slides[b]).clone(!0).attr("id", "").attr("data-slick-index", b + _.slideCount).appendTo(_.$slideTrack).addClass("slick-cloned");
        ...
        var a, c, h, g, d, i = null,
            _ = this;
        if (e = e || !1, (!0 !== _.animating || !0 !== _.options.waitForAnimate) && (!0 !== _.options.fade || _.currentSlide !== b)) {
            if (!1 === e && _.asNavFor(b), a = b, i = _.getLeft(a), g = _.getLeft(_.currentSlide), _.currentLeft = null === _.swipeLeft ? g : _.swipeLeft, !1 === _.options.infinite && !1 === _.options.centerMode && (b < 0 || b > _.getDotCount() * _.options.slidesToScroll) || !1 === _.options.infinite && !0 === _.options.centerMode && (b < 0 || b > _.slideCount - _.options.slidesToScroll)) {
                !1 === _.options.fade && (a = _.currentSlide, !0 !== f && _.slideCount > _.options.slidesToShow ? _.animateSlide(g, function() {
                    _.postSlide(a)
                }) : _.postSlide(a));
                return
            }
            if (_.options.autoplay && clearInterval(_.autoPlayTimer), c = a < 0 ? _.slideCount % _.options.slidesToScroll != 0 ? _.slideCount - _.slideCount % _.options.slidesToScroll : _.slideCount + a : a >= _.slideCount ? _.slideCount % _.options.slidesToScroll != 0 ? 0 : a - _.slideCount : a, _.animating = !0, _.$slider.trigger("beforeChange", [_, _.currentSlide, c]), h = _.currentSlide, _.currentSlide = c, _.setSlideClasses(_.currentSlide), _.options.asNavFor && (d = (d = _.getNavTarget()).slick("getSlick")).slideCount <= d.options.slidesToShow && d.setSlideClasses(_.currentSlide), _.updateDots(), _.updateArrows(), !0 === _.options.fade) {
                !0 !== f ? (_.fadeSlideOut(h), _.fadeSlide(c, function() {
                    _.postSlide(c)
                })) : _.postSlide(c), _.animateHeight();
                return
            }!0 !== f && _.slideCount > _.options.slidesToShow ? _.animateSlide(i, function() {
                _.postSlide(c)
            }) : _.postSlide(c)
        }
        ...
        var _ = this;
        if (!1 !== _.options.swipe && (!("ontouchend" in document) || !1 !== _.options.swipe) && (!1 !== _.options.draggable || -1 === a.type.indexOf("mouse"))) switch (_.touchObject.fingerCount = a.originalEvent && void 0 !== a.originalEvent.touches ? a.originalEvent.touches.length : 1, _.touchObject.minSwipe = _.listWidth / _.options.touchThreshold, !0 === _.options.verticalSwiping && (_.touchObject.minSwipe = _.listHeight / _.options.touchThreshold), a.data.action) {
            case "start":
                _.swipeStart(a);
                break;
            case "move":
        ...
        var e, f, c, d, a, g, _ = this;
        return a = void 0 !== b.originalEvent ? b.originalEvent.touches : null, !!_.dragging && !_.scrolling && (!a || 1 === a.length) && ((e = _.getLeft(_.currentSlide), _.touchObject.curX = void 0 !== a ? a[0].pageX : b.clientX, _.touchObject.curY = void 0 !== a ? a[0].pageY : b.clientY, _.touchObject.swipeLength = Math.round(Math.sqrt(Math.pow(_.touchObject.curX - _.touchObject.startX, 2))), g = Math.round(Math.sqrt(Math.pow(_.touchObject.curY - _.touchObject.startY, 2))), _.options.verticalSwiping || _.swiping || !(g > 4)) ? (!0 === _.options.verticalSwiping && (_.touchObject.swipeLength = g), f = _.swipeDirection(), void 0 !== b.originalEvent && _.touchObject.swipeLength > 4 && (_.swiping = !0, b.preventDefault()), d = (!1 === _.options.rtl ? 1 : -1) * (_.touchObject.curX > _.touchObject.startX ? 1 : -1), !0 === _.options.verticalSwiping && (d = _.touchObject.curY > _.touchObject.startY ? 1 : -1), c = _.touchObject.swipeLength, _.touchObject.edgeHit = !1, !1 === _.options.infinite && (0 === _.currentSlide && "right" === f || _.currentSlide >= _.getDotCount() && "left" === f) && (c = _.touchObject.swipeLength * _.options.edgeFriction, _.touchObject.edgeHit = !0), !1 === _.options.vertical ? _.swipeLeft = e + c * d : _.swipeLeft = e + c * (_.$list.height() / _.listWidth) * d, !0 === _.options.verticalSwiping && (_.swipeLeft = e + c * d), !0 !== _.options.fade && !1 !== _.options.touchMove && (!0 === _.animating ? (_.swipeLeft = null, !1) : void _.setCSS(_.swipeLeft))) : (_.scrolling = !0, !1))
        ...
        void 0 !== a.originalEvent && void 0 !== a.originalEvent.touches && (b = a.originalEvent.touches[0]), _.touchObject.startX = _.touchObject.curX = void 0 !== b ? b.pageX : a.clientX, _.touchObject.startY = _.touchObject.curY = void 0 !== b ? b.pageY : a.clientY, _.dragging = !0
    }, a.prototype.unfilterSlides = a.prototype.slickUnfilter = function() {
        null !== this.$slidesCache && (this.unload(), this.$slideTrack.children(this.options.slide).detach(), this.$slidesCache.appendTo(this.$slideTrack), this.reinit())
    }, a.prototype.unload = function() {
        $(".slick-cloned", this.$slider).remove(), this.$dots && this.$dots.remove(), this.$prevArrow && this.htmlExpr.test(this.options.prevArrow) && this.$prevArrow.remove(), this.$nextArrow && this.htmlExpr.test(this.options.nextArrow) && this.$nextArrow.remove(), this.$slides.removeClass("slick-slide slick-active slick-visible slick-current").attr("aria-hidden", "true").css("width", "")
        ...
        var b, d, _ = this,
            ...
            f = _.length;
        for (b = 0; b < f; b++)
            if ("object" == typeof c || void 0 === c ? _[b].slick = new a(_[b], c) : d = _[b].slick[c].apply(_[b].slick, e), void 0 !== d) return d;
        return _
    }
})