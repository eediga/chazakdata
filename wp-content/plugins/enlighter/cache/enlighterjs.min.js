...
var EnlighterJS = function(e) {
    ...
    function r(e, t, n) {
        t && T(e.prototype, t), n && T(e, n), Object.defineProperty(e, "prototype", {
            writable: !1
        })
    }
    ...
    function Z(e, t, n) {
                ...
                var o = function(e, t, n) {
                        for (var r, i = [], a = 0; null != (r = t.regex.exec(e));) {
                            ...
                            if (0 != r[0].length) {
                                ...
                                if (1 < r.length)
                                    for (var l, g, u, p = 0, c = 1; c < r.length; c++) r[c] && (l = Array.isArray(t.type) && t.type.length >= c ? t.type[c - 1] : s, g = Array.isArray(t.filter) && t.filter.length >= c ? t.filter[c - 1] : o, u = r[0].indexOf(r[c], p), i.push(b(r[c], l, g, r.index + (p = u), n)));
                                else i.push(b(r[0], s, o, r.index, n))
                            }
                        }
                        return i
                    }(e, s, a),
        ...
        for (var l = [], g = 0, u = 0; u < i.length; u++) {
            if (g < i[u].index && l.push(b(e.substring(g, i[u].index), r, null, g)), i[u].filter)
    ...
    function Pe(e, t, n) {
        ...
        if (0 < n.length)
            for (var s = 0; s < n.length; s++) {
                var o = n[s];
                if (null !== o && !1 !== o)
                    if (void 0 === o) a.appendChild(i.createTextNode("#INVALID_ELEMENT#"));
                    else if (o.push)
    ...
    function W(e) {
        ...
        return e.name && t.push("enlighter-btn-" + e.name), L("div", {
            className: t.join(" "),
            onClick: e.onClick
        }, e.text || null, ("string" == typeof e.tooltip ? L(Je, {
            text: e.tooltip
        }) : e.tooltip) || null)
    }
    var Ye = "Error: unable to copy to clipboard",
        Xe = "Code copied!",
        Ke = "Copy to clipboard";
            ...
            return L(W, {
                ...
                onClick: function() {
                    var e = function(e) {
                        ...
                        try {
                            var r = t.createRange(),
                                i = (r.selectNodeContents(e), n.getSelection());
    ...
    function nt(e) {
        ...
        return !0 === n.linehover && r.push("enlighter-hover"), !0 === n.linenumbers && r.push("enlighter-linenumbers"), "scroll" === n.textOverflow && r.push("enlighter-overflow-scroll"), !0 === n.collapse && r.push("enlighter-collapse"), 0 < n.cssClasses.length && r.push.apply(r, g(n.cssClasses)), t = L(I, {
            className: r
        }, L($, {
            name: "top",
            layout: n.toolbarTop,
    ...
    var at = Object.freeze({
        ...
        inline: function(e) {
            ...
            return 0 < t.cssClasses.length && n.push.apply(n, g(t.cssClasses)), L(I, {
                className: n
            }, L(rt, {
                tokens: e[0].tokens,
                options: t
    ...
    function st(e) {
        ...
        return t = ((t = e[0].params.layout) || "").toLowerCase(), (at[t] || nt)(e.map(function(e) {
            ...
            return v[n = r] || (v[n] = new k[n]), {
                tokens: v[n].analyze(t),
                params: e,
                code: t,
                resolvedLanguage: r
            }
    ...
    function lt(e) {
        var e = function(e) {
            for (var t = 0; t < O.length; t++)
                for (var n = 0; n < O[t].elements.length; n++)
                    if (O[t].elements[n] === e) return t;
            return !1
        }(e);
    ...
    function D(e) {
        ...
        try {
            return 0 === (e = Array.isArray(e) ? e : [e]).length ? !1 : !1 === a ? lt(e[0]) : !Me(e[0], "enlighter-origin") && (t = st(e.map(function(e) {
                ...
                return A(e, "enlighter-origin"), {
                    element: e,
                    code: i,
                    params: r
                }
            })), Ze(e[0], t), n = e, r = t, O.push({
                elements: n,
                wrapper: r
            }), !0)
        } catch (e) {
    ...
    return e.enlight = D, e.init = function() {
        for (var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : "pre.ejs", t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : "code.ejs", n = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : null, r = 3 < arguments.length && void 0 !== arguments[3] ? arguments[3] : {}, n = (n = n, Object.assign(u, n || {}), E(e)), i = E(t), a = (e = function(e) {
            ...
            }(n)).standalone, s = e.groups, o = 0; o < a.length; o++) D(a[o], {
            layout: r.block || "standard"
        });
        for (var l = 0; l < s.length; l++) D(s[l], {
            layout: r.codegroup || "codegroup"
        });
        for (var g = 0; g < i.length; g++) D(i[g], {
            layout: r.inline || "inline"
        })
    }, e.version = "3.6.0", Object.defineProperty(e, "__esModule", {
        value: !0
    }), e
}({});
! function(n) {
